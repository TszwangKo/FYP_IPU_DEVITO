          ...
          for (int x = x0_blk0; x <= MIN(x_M, x0_blk0 + x0_blk0_size - 1); x += 1)
          {
            for (int y = y0_blk0; y <= MIN(y_M, y0_blk0 + y0_blk0_size - 1); y += 1)
            {
              ...
              for (int z = z_m; z <= z_M; z += 1)
              {
                ...
                u[t2][x + 4][y + 4][z + 4] = 
                  ( r1*damp[x + 4][y + 4][z + 4]*u[t0][x + 4][y + 4][z + 4] 
                    + r2 * (
                        - r0*(-2.0F*u[t0][x + 4][y + 4][z + 4]) 
                        - r0*u[t1][x + 4][y + 4][z + 4])
                    + 8.33333315e-4F*(
                      - u[t0][x + 2][y + 4][z + 4] - u[t0][x + 4][y + 2][z + 4] - u[t0][x + 4][y + 4][z + 2] 
                      - u[t0][x + 4][y + 4][z + 6] - u[t0][x + 4][y + 6][z + 4] - u[t0][x + 6][y + 4][z + 4]
                      ) 
                    + 1.3333333e-2F*(
                        u[t0][x + 3][y + 4][z + 4] + u[t0][x + 4][y + 3][z + 4] + u[t0][x + 4][y + 4][z + 3] 
                      + u[t0][x + 4][y + 4][z + 5] + u[t0][x + 4][y + 5][z + 4] + u[t0][x + 5][y + 4][z + 4]
                      ) 
                    - 7.49999983e-2F*u[t0][x + 4][y + 4][z + 4]
                    )
                    /(r0*r2 + r1*damp[x + 4][y + 4][z + 4]);
              }
            }
          }
        }
